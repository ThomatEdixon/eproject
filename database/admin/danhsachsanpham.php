<?php
    ...
    $product = mysqli_query($conn, "SELECT product.*, type.nametype as kieu_Dang, category.namecategory as danh_muc FROM product  INNER JOIN type on type.typeid = product.typeid INNER JOIN category on category.categoryid = product.categoryid");
